...
class Menu6GUI(tk.Tk):
    def __init__(roo):
        ...
        def displayMenu6():
            ...
            buttonTambahPesanan = Button(roo, text="Tambahkan ke Pesanan",command=lambda jumlah_barang=spbox.get() : tambah.TambahProduk(6, jumlah_barang, "Es Teh Manis/Teh manis", 4000.0), bg= '#FBB43C')
